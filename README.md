...
| `finance web` | Interactive local dashboard (localhost): explore **and** tag uncategorised |
| `finance review` | Interactively name unknown IBANs/merchants in the terminal (learns permanently) |
